"""
2-Layer Deep Neural Network to predict Airbnb NYC 2019 listing price.
Architecture: Input -> Hidden Layer 1 (128, ReLU) -> Hidden Layer 2 (64, ReLU) -> Output (1)
"""
...
}, os.path.join(MODEL_DIR, 'model_2layer.pth'))

with open(os.path.join(MODEL_DIR, 'scaler_2layer.pkl'), 'wb') as f:
    pickle.dump(scaler, f)

print("\nModel saved  ->  model_2layer.pth")
print("Scaler saved ->  scaler_2layer.pkl")
